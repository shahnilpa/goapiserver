...
{{ include "gohttpserver.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "gohttpserver.selectorLabels" -}}
...
*/}}
{{- define "gohttpserver.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "gohttpserver.fullname" .) .Values.serviceAccount.name }}
{{- else }}
